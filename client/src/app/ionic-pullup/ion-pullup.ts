...
export class IonPullUpComponent  {
  ...
  collapse(isInit: boolean = false) {
    this._footerMeta.lastPosY = this._footerMeta.height - this._footerMeta.defaultHeight - this._currentViewMeta.tabsHeight -this._heightBox;
    /* console.log("default ",this._footerMeta.defaultHeight);
    console.log("current ",this._currentViewMeta.tabsHeight);
    console.log("height ",this._footerMeta.height);
    console.log("applied ",this._footerMeta.lastPosY ); */
  ...
  minimize() {
    this._footerMeta.lastPosY = this._footerMeta.height - 26;
    this.renderer.setElementStyle(this.childFooter.nativeElement, '-webkit-transform', 'translate3d(0, ' + this._footerMeta.lastPosY + 'px, 0)');
    this.renderer.setElementStyle(this.childFooter.nativeElement, 'transform', 'translate3d(0, ' + this._footerMeta.lastPosY + 'px, 0)');
